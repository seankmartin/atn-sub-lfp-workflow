...
from plots import plot_pos_over_time
from tmaze_layout import t_maze_dict


def analyse_recording(recording):
    spatial = recording.data["spatial"].data
...
def main(
    ...
    for folder in os.listdir(t_maze_dir):
        ...
        recording = simuran.Recording(
            attrs=simuran.ParamHandler(source_file=mapping_file, name="mapping"),
            loader=simuran.loader_from_string("neurochat"),
            source_file=set_file_location,
        )
